...
- **An Introduction to Statistical Learning, with Applications in Python**; Gareth James, Daniela Witten, Trevor Hastie, Robert Tibishirani, Jonathan Taylor
...
- **The AI Breakdown**; Nathaniel Whittemore
	- High-level podcast about latest stories and option pieces in AI
